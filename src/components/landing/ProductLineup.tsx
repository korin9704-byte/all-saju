...
const thumbMap: Record<string, React.ReactNode> = {
  ...
  "reunion-saju":    <img src="/images/reunion-saju.png" alt="재회 사주" className="w-full h-full object-cover" />,
};
    ...
    <section id="products" className="container pt-3 pb-16">
      ...
      <div className="mb-10">
        <img
          ...
          className="w-full h-auto rounded-2xl border-2 border-hairline transition-all shadow-sm hover:shadow-md hover:border-ink"
        />
      </div>
