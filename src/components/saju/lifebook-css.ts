...
.lifebook .cal-pct{display:block;font-size:12.5px;color:var(--pink);margin-top:2px;text-decoration:underline;text-underline-offset:3px;text-decoration-thickness:1.2px;}
