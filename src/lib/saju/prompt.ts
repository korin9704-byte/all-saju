...
- [해결 확률 필수] 첫 번째 주제 본문 안에서 이 고민이 해결될 가능성을 반드시 구체적인 퍼센트 숫자로 제시하세요. 예: "이 고민, 해결될 가능성은 80%예요." 사주와 운의 흐름을 근거로 산출한 숫자여야 하며, 왜 그 확률인지 이유도 함께 서술하세요. 두루뭉술하게 "높아요/낮아요"로만 쓰는 것은 금지합니다.
- [풀리는 시기 필수] 첫 번째 주제 본문 안에서 고민이 풀리는 시기를 반드시 구체적인 연도와 월(또는 분기)로 제시하세요. 예: "풀리는 시기는 2026년 10월쯤이에요." 현재 날짜 이후의 시기여야 하며, 대운·세운 흐름을 근거로 왜 그 시기인지 이유도 함께 서술하세요.
- 각 주제 본문은 반드시 800자 이상 작성하세요. 그 이하로 쓰면 안 됩니다.
- 전문 용어(천간, 지지, 십성, 재성 등)는 쓰지 말고 일상 언어로 풀어 설명하세요.
