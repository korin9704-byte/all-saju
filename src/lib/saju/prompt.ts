...
위 사주 데이터를 바탕으로 부동산 투자 운에 대해 5개 섹션으로 구성된 리포트를 작성하세요.
...
- 전문 용어(천간, 지지, 십성, 재성, 관성 등)는 쓰지 마세요. 꼭 써야 하면 괄호로 쉬운 설명을 붙이세요.
- 친한 선배나 상담사처럼 따뜻하고 자연스러운 말투로 쓰세요.
- 각 섹션 최소 600자 이상, 전체 3,500자 이상 작성하세요.
...
출력 형식:
## [부동산 운 전반 — 타고난 재물·부동산 기운 분석]

[본문]

## [지금이 살 때인가, 기다릴 때인가 — 현재 대운·세운 분석]

[본문]

## [어떤 부동산이 나에게 맞을까 — 투자 유형과 지역 성향]

[본문]

## [주의해야 할 함정 — 리스크와 실패 패턴]

[본문]

## [부동산 부자가 되기 위한 나만의 전략]

[본문]
${concern ? "\n위 섹션을 모두 작성한 뒤, 마지막에 ## 고민 답변 섹션을 추가하여 내담자의 궁금한 점에 사주 근거와 함께 직접 답변하세요." : ""}`;
