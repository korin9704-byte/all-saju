...
- [됩니다/안 됩니다 판정 필수] 첫 번째 주제 본문 안에서 고민에 대한 결론을 반드시 명확하게 판정해 주세요. 고민 내용에 맞는 자연스러운 문장으로, 됩니다 또는 안 됩니다 쪽을 분명히 밝히세요. 예: "결론부터 말하면, 이직 해도 됩니다", "지금 이 투자는 안 하시는 게 맞아요", "이 사람과는 계속 가도 됩니다". 양쪽 다 열어 두는 애매한 결론("~일 수도 있고 아닐 수도 있어요")은 금지합니다. 다만 판정 뒤에 조건이나 주의점을 덧붙이는 것은 좋습니다.
