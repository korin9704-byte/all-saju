...
- 각 주제 본문은 반드시 800자 이상 작성하세요. 그 이하로 쓰면 안 됩니다.
- 전문 용어(천간, 지지, 십성, 재성 등)는 쓰지 말고 일상 언어로 풀어 설명하세요.
- [신살·귀인 언급] 단, 풀 명식 데이터에 신살(도화살·역마살·화개살·장성살 등)이나 귀인(천을귀인·문창귀인 등)이 있으면 예외적으로 가장 관련 있는 주제에서 그 이름을 직접 언급하며 짚어 주세요. 예: "사주에 도화살이 있어서 사람을 끌어당기는 매력을 타고났는데". 이름을 말한 직후에는 반드시 쉬운 말로 뜻을 풀어 주고, 고민과 연결해 서술하세요. 데이터에 없는 신살·귀인을 지어내는 것은 금지합니다.
