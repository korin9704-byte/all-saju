...
- 모든 ### 소제목 본문마다 가장 중요한 문장 1개(핵심 결론이 둘이면 2개까지)를 **문장** 형태로 강조하세요. 특히 재회 확률·점수, 구체적 시기·날짜, 됩니다/안 됩니다 판정, 해야 할·하지 말아야 할 핵심 행동은 반드시 강조하세요. 강조된 문장은 결과지에서 눈에 띄는 색으로 표시되므로, 그 문장만 읽어도 결론이 통하게 쓰세요.
...
- "지금 상황 풀이": 내담자가 겪은 변화("${situation ?? question}")가 사주 흐름상 무엇을 뜻하는지 첫 문장에 결론부터. 600~900자.
...
- 내담자의 질문에는 가장 관련 있는 장에서 직접 답하세요.
