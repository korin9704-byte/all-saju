    ...
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
        <tr><td style="background:#111111;padding:32px 40px;text-align:center;">
          <span style="color:#ffffff;font-size:22px;font-weight:700;letter-spacing:-0.5px;font-family:'Jua','Apple SD Gothic Neo',sans-serif;">냥점🐱</span>
        </td></tr>
        <tr><td style="padding:40px 40px 24px;">
          <p style="margin:0 0 8px;font-size:15px;color:#555;font-family:'Jua','Apple SD Gothic Neo',sans-serif;">안녕하세요!</p>
          <h1 style="margin:0 0 24px;font-size:20px;font-weight:700;color:#111;line-height:1.4;font-family:'Jua','Apple SD Gothic Neo',sans-serif;">
            ${greeting} <span style="color:#6366f1;">${productName}</span><br>결과지가 준비됐어요.
          </h1>
          <p style="margin:0 0 32px;font-size:14px;color:#666;line-height:1.7;font-family:'Jua','Apple SD Gothic Neo',sans-serif;">
            아래 버튼을 눌러 결과지를 확인하세요.<br>
            링크는 언제든지 다시 접근하실 수 있어요.
          </p>
          <a href="${url}" style="display:block;background:#111111;color:#ffffff;text-decoration:none;padding:16px 32px;border-radius:9999px;font-size:15px;font-weight:700;text-align:center;font-family:'Jua','Apple SD Gothic Neo',sans-serif;">
            결과지 보러가기 →
          </a>
        </td></tr>
        <tr><td style="padding:24px 40px 40px;border-top:1px solid #f0f0f0;">
          <p style="margin:0;font-size:12px;color:#aaa;line-height:1.6;font-family:'Jua','Apple SD Gothic Neo',sans-serif;">
