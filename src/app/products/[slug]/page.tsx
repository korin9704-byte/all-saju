        ...
        <div className="w-full max-w-lg">
          ...
          >
            <div className="mt-auto pb-2">
              ...
              {product.description && (
                <p className="mt-2 text-[16.5px] text-ink leading-relaxed">
          ...
          <div className="px-4 pb-14">
            ...
            {productDescriptions[product.slug] && (
              <div className="mt-8 space-y-3 text-[16.5px] text-ink leading-relaxed">
            ...
            <section className="mt-8">
              <FreeTroubleStart productId={product.id} mode="paid" askConcern={product.slug === "trouble-saju"} askJob={product.slug === "life-saju"} basePrice={product.price} bundle={bundle} label={product.slug === "life-saju" ? "내 인생 설명서 보기!!" : undefined} />
            </section>
          </div>
        </div>
      </div>
